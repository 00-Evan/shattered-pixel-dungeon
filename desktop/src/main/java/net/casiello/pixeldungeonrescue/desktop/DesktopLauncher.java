...
package net.casiello.pixeldungeonrescue.desktop;
...
import net.casiello.pixeldungeonrescue.services.updates.UpdateImpl;
import net.casiello.pixeldungeonrescue.services.updates.Updates;
	...
	public static void main (String[] args) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			public void uncaughtException(Thread thread, Throwable throwable) {
				...
				exceptionMsg = exceptionMsg.replace("net.casiello.pixeldungeonrescue.", "");
