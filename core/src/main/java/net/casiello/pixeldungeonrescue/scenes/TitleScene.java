...
import net.casiello.pixeldungeonrescue.effects.BannerSprites;
import net.casiello.pixeldungeonrescue.effects.Fireball;
...
import net.casiello.pixeldungeonrescue.ui.LanguageButton;
import net.casiello.pixeldungeonrescue.ui.PrefsButton;
import net.casiello.pixeldungeonrescue.ui.StyledButton;
import net.casiello.pixeldungeonrescue.ui.UpdateNotification;
import net.casiello.pixeldungeonrescue.windows.WndOptions;
import net.casiello.pixeldungeonrescue.windows.WndStartGame;
...
//		add(btnSupport);
		...
		if (landscape()) {
			...
			btnRankings.setRect( btnPlay.left(), btnPlay.bottom()+ GAP, (title.width()/2)-1, BTN_HEIGHT);
