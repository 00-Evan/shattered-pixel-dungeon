...
import net.casiello.pixeldungeonrescue.levels.painters.HallsPainter;
import net.casiello.pixeldungeonrescue.levels.painters.Painter;
import net.casiello.pixeldungeonrescue.levels.rooms.Room;
import net.casiello.pixeldungeonrescue.levels.rooms.special.DemonSpawnerRoom;
import net.casiello.pixeldungeonrescue.levels.traps.BlazingTrap;
import net.casiello.pixeldungeonrescue.levels.traps.CorrosionTrap;
import net.casiello.pixeldungeonrescue.levels.traps.CursingTrap;
import net.casiello.pixeldungeonrescue.levels.traps.DisarmingTrap;
import net.casiello.pixeldungeonrescue.levels.traps.DisintegrationTrap;
import net.casiello.pixeldungeonrescue.levels.traps.DistortionTrap;
import net.casiello.pixeldungeonrescue.levels.traps.FlashingTrap;
...
import net.casiello.pixeldungeonrescue.levels.traps.GuardianTrap;
import net.casiello.pixeldungeonrescue.levels.traps.PitfallTrap;
import net.casiello.pixeldungeonrescue.levels.traps.RockfallTrap;
import net.casiello.pixeldungeonrescue.levels.traps.StormTrap;
import net.casiello.pixeldungeonrescue.levels.traps.SummoningTrap;
import net.casiello.pixeldungeonrescue.levels.traps.WarpingTrap;
import net.casiello.pixeldungeonrescue.levels.traps.WeakeningTrap;
