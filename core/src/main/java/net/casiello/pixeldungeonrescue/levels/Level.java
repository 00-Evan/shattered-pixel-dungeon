...
import net.casiello.pixeldungeonrescue.actors.blobs.WellWater;
...
import net.casiello.pixeldungeonrescue.actors.buffs.MagicalSight;
import net.casiello.pixeldungeonrescue.actors.buffs.MindVision;
import net.casiello.pixeldungeonrescue.actors.buffs.Shadows;
...
import net.casiello.pixeldungeonrescue.actors.mobs.Bestiary;
...
import net.casiello.pixeldungeonrescue.items.Stylus;
...
import net.casiello.pixeldungeonrescue.levels.features.HighGrass;
...
public abstract class Level implements Bundlable {
	...
	public void updateFieldOfView( Char c, boolean[] fieldOfView ) {
		...
		if (c.isAlive() && c == Dungeon.hero) {
			...
			} else if (((Hero)c).heroClass == HeroClass.HUNTER_F || ((Hero)c).heroClass == HeroClass.HUNTER_M ) {
				for (Mob mob : mobs) {
					int p = mob.pos;
