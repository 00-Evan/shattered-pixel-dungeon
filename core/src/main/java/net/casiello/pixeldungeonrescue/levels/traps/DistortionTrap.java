...
import net.casiello.pixeldungeonrescue.actors.mobs.Acidic;
import net.casiello.pixeldungeonrescue.actors.mobs.Albino;
import net.casiello.pixeldungeonrescue.actors.mobs.ArmoredBrute;
import net.casiello.pixeldungeonrescue.actors.mobs.Bandit;
import net.casiello.pixeldungeonrescue.actors.mobs.Bestiary;
import net.casiello.pixeldungeonrescue.actors.mobs.CausticSlime;
import net.casiello.pixeldungeonrescue.actors.mobs.DM201;
...
import net.casiello.pixeldungeonrescue.actors.mobs.Senior;
import net.casiello.pixeldungeonrescue.actors.mobs.Statue;
import net.casiello.pixeldungeonrescue.actors.mobs.Wraith;
import net.casiello.pixeldungeonrescue.actors.mobs.npcs.RatKing;
