...
package net.casiello.pixeldungeonrescue.levels.rooms.sewerboss;

import net.casiello.pixeldungeonrescue.actors.mobs.Goo;
...
import net.casiello.pixeldungeonrescue.levels.rooms.connection.PerimeterRoom;
