...
package net.casiello.pixeldungeonrescue.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"net/casiello/pixeldungeonrescue/messages/actors/actors",
			"net/casiello/pixeldungeonrescue/messages/items/items",
			"net/casiello/pixeldungeonrescue/messages/journal/journal",
			"net/casiello/pixeldungeonrescue/messages/levels/levels",
			"net/casiello/pixeldungeonrescue/messages/plants/plants",
			"net/casiello/pixeldungeonrescue/messages/scenes/scenes",
			"net/casiello/pixeldungeonrescue/messages/ui/ui",
			"net/casiello/pixeldungeonrescue/messages/windows/windows",
			"net/casiello/pixeldungeonrescue/messages/misc/misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("net.casiello.pixeldungeonrescue.", "");
			key += "." + k;
		} else
			key = k;
