...
import net.casiello.pixeldungeonrescue.items.armor.curses.AntiEntropy;
import net.casiello.pixeldungeonrescue.items.armor.curses.Bulk;
import net.casiello.pixeldungeonrescue.items.armor.curses.Corrosion;
import net.casiello.pixeldungeonrescue.items.armor.curses.Displacement;
import net.casiello.pixeldungeonrescue.items.armor.curses.Metabolism;
import net.casiello.pixeldungeonrescue.items.armor.curses.Multiplicity;
import net.casiello.pixeldungeonrescue.items.armor.curses.Overgrowth;
import net.casiello.pixeldungeonrescue.items.armor.curses.Stench;
import net.casiello.pixeldungeonrescue.items.armor.glyphs.Affection;
...
import net.casiello.pixeldungeonrescue.items.armor.glyphs.Entanglement;
import net.casiello.pixeldungeonrescue.items.armor.glyphs.Flow;
import net.casiello.pixeldungeonrescue.items.armor.glyphs.Obfuscation;
import net.casiello.pixeldungeonrescue.items.armor.glyphs.Potential;
import net.casiello.pixeldungeonrescue.items.armor.glyphs.Repulsion;
import net.casiello.pixeldungeonrescue.items.armor.glyphs.Stone;
import net.casiello.pixeldungeonrescue.items.armor.glyphs.Swiftness;
import net.casiello.pixeldungeonrescue.items.armor.glyphs.Thorns;
