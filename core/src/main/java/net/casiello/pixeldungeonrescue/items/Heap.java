...
import net.casiello.pixeldungeonrescue.items.food.ChargrilledMeat;
import net.casiello.pixeldungeonrescue.items.food.FrozenCarpaccio;
import net.casiello.pixeldungeonrescue.items.food.MysteryMeat;
import net.casiello.pixeldungeonrescue.items.journal.DocumentPage;
