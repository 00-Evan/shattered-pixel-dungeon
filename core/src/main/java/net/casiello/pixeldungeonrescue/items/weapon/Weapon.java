...
package net.casiello.pixeldungeonrescue.items.weapon;
...
import net.casiello.pixeldungeonrescue.actors.buffs.MagicImmune;
...
import net.casiello.pixeldungeonrescue.items.weapon.curses.Annoying;
import net.casiello.pixeldungeonrescue.items.weapon.curses.Displacing;
import net.casiello.pixeldungeonrescue.items.weapon.curses.Exhausting;
import net.casiello.pixeldungeonrescue.items.weapon.curses.Fragile;
import net.casiello.pixeldungeonrescue.items.weapon.curses.Friendly;
import net.casiello.pixeldungeonrescue.items.weapon.curses.Polarized;
import net.casiello.pixeldungeonrescue.items.weapon.curses.Sacrificial;
import net.casiello.pixeldungeonrescue.items.weapon.curses.Wayward;
import net.casiello.pixeldungeonrescue.items.weapon.enchantments.Blazing;
import net.casiello.pixeldungeonrescue.items.weapon.enchantments.Blocking;
import net.casiello.pixeldungeonrescue.items.weapon.enchantments.Blooming;
import net.casiello.pixeldungeonrescue.items.weapon.enchantments.Chilling;
import net.casiello.pixeldungeonrescue.items.weapon.enchantments.Kinetic;
import net.casiello.pixeldungeonrescue.items.weapon.enchantments.Corrupting;
import net.casiello.pixeldungeonrescue.items.weapon.enchantments.Elastic;
import net.casiello.pixeldungeonrescue.items.weapon.enchantments.Grim;
import net.casiello.pixeldungeonrescue.items.weapon.enchantments.Lucky;
import net.casiello.pixeldungeonrescue.items.weapon.enchantments.Projecting;
import net.casiello.pixeldungeonrescue.items.weapon.enchantments.Shocking;
import net.casiello.pixeldungeonrescue.items.weapon.enchantments.Unstable;
import net.casiello.pixeldungeonrescue.items.weapon.enchantments.Vampiric;
