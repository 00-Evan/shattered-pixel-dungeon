...
import net.casiello.pixeldungeonrescue.items.quest.CeremonialCandle;
import net.casiello.pixeldungeonrescue.items.quest.CorpseDust;
...
import net.casiello.pixeldungeonrescue.levels.rooms.special.MassGraveRoom;
import net.casiello.pixeldungeonrescue.levels.rooms.special.RotGardenRoom;
import net.casiello.pixeldungeonrescue.levels.rooms.standard.RitualSiteRoom;
...
import net.casiello.pixeldungeonrescue.sprites.WandmakerSprite;
import net.casiello.pixeldungeonrescue.windows.WndQuest;
import net.casiello.pixeldungeonrescue.windows.WndWandmaker;
		...
		if (Quest.given) {
			...
			switch(Dungeon.hero.heroClass.heroType()){
				...
				case MAGE:
					...
					break;
				case HUNTER:
					msg1 += Messages.get(this, "intro_hunter");
					break;
			}
