...
public abstract class Wand extends Item {
        ...
        public void onSelect(Integer target) {
            ...
            if (target != null) {
                ...
                if (curWand.tryToZap(curUser, target)) {
                    ...
                    if (curWand.blessedType == CURSED) {
                        if (!curWand.blessedTypeKnown) {
    ...
    public String info() {
        ...
        if (blessedType != NORMAL && blessedTypeKnown) {
            desc += "\n\n" + switch (blessedType) {
                default -> "";
    ...
    @Override
    public int level() {
        if (blessedType != CURSED && curseInfusionBonus) {
    ...
    public void wandUsed() {
        ...
        curCharges -= blessedType==CURSED ? 1 : chargesPerCast();
    ...
    public int collisionProperties(int target) {
        if (blessedType == CURSED) return Ballistica.MAGIC_BOLT;
