...
public class HuntingRifle extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(HuntingRifle.class, "stats_known",
                    Math.round(Bulletmin(HuntingRifle.this.buffedLvl())),
                    Math.round(Bulletmax(HuntingRifle.this.buffedLvl())),
    ...
    public class Bullet extends MissileWeapon {
        ...
        @Override
        public int damageRoll(Char owner) {
            int damage = Random.NormalIntRange(Bulletmin(HuntingRifle.this.buffedLvl()), Bulletmax(HuntingRifle.this.buffedLvl()));
