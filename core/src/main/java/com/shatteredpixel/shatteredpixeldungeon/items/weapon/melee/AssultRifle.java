...
public class AssultRifle extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(AssultRifle.class, "stats_known",
                    Bulletmin(AssultRifle.this.buffedLvl()),
                    Bulletmax(AssultRifle.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(AssultRifle.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, reload_time);
        }
    ...
    public AssultRifle.Bullet knockBullet(){
        return new AssultRifle.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int damageRoll(Char owner) {
            if (owner.buff(Momentum.class) != null && owner.buff(Momentum.class).freerunning()) {
                return Math.round(Random.NormalIntRange(Bulletmin(AssultRifle.this.buffedLvl()), Bulletmax(AssultRifle.this.buffedLvl())) * (1f + 0.15f * ((Hero) owner).pointsInTalent(Talent.PROJECTILE_MOMENTUM)));
            } else {
                return Random.NormalIntRange(Bulletmin(AssultRifle.this.buffedLvl()), Bulletmax(AssultRifle.this.buffedLvl()));
            }
        }

        @Override
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return AssultRifle.this.hasEnchant(type, owner);
        }

        @Override
        public int proc(Char attacker, Char defender, int damage) {
            return AssultRifle.this.proc(attacker, defender, damage);
        }

        @Override
        public float delayFactor(Char user) {
            return AssultRifle.this.delayFactor(user);
        }
