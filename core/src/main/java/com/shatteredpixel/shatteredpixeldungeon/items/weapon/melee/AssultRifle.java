...
public class AssultRifle extends MeleeWeapon {
    ...
    public int Bulletmax(int lvl) {
        return 2 * (tier + 1)   +                                                           //if you make something different guns, you should change this
                lvl * (tier + 1) +                                                           //if you make something different guns, you should change this
                RingOfSharpshooting.levelDamageBonus(Dungeon.hero);
    }
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(AssultRifle.class, "stats_known",
                    Math.round(Bulletmin(AssultRifle.this.buffedLvl())),
                    Math.round(Bulletmax(AssultRifle.this.buffedLvl())),
    ...
    public class Bullet extends MissileWeapon {
        ...
        public void cast(final Hero user, final int dst) {
            ...
            AssultRifle.this.targetPos = cell;
