...
public class PlankShield extends MeleeWeapon {

	{
		image = ItemSpriteSheet.ROUND_SHIELD; // Using round shield sprite for now
	...
	public int max(int lvl) {
		return  Math.round(2.5f*(tier+1)) +  // 5 base damage (weaker than round shield)
	...
	// 3 extra defence, plus 1 per level (weaker than round shield at tier 1)
