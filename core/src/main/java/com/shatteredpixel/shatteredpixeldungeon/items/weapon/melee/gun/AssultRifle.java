...
public class AssultRifle extends GunsWeapon {
    ...
    public class Bullet extends MissileWeapon {
        ...
        public int damageRoll(Char owner) {
            ...
            if (owner.buff(Momentum.class) != null && owner.buff(Momentum.class).freerunning()) {
                bulletdamage = Math.round(Random.NormalIntRange(Bulletmin(AssultRifle.this.buffedLvl()), Bulletmax(AssultRifle.this.buffedLvl())) * (1f + 0.15f * ((Hero) owner).pointsInTalent(Talent.PROJECTILE_MOMENTUM)));
            } else {
