...
public class ToxicParticle extends PixelParticle {

	public static final Emitter.Factory MISSILE = new Emitter.Factory() {
		@Override
		public void emit( Emitter emitter, int index, float x, float y ) {
			((ToxicParticle)emitter.recycle( ToxicParticle.class )).resetMissile( x, y );
		}
		@Override
	...
	public static final Emitter.Factory SPLASH = new Emitter.Factory() {
		@Override
		public void emit( Emitter emitter, int index, float x, float y ) {
			((ToxicParticle)emitter.recycle( ToxicParticle.class )).resetSplash( x, y );
		}
		@Override
		public boolean lightMode() {
			return false;
	...
	public void update() {
		...
		color( ColorMath.interpolate( 0x00FF00, 0x32aa50, am ) );
	}
