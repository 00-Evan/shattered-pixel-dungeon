...
import com.shatteredpixel.shatteredpixeldungeon.ui.changelist.pdr_v1_X_Changes;
...
public class ChangesScene extends PixelScene {
	...
	public void create() {
		...
		switch (changesSelected){
			case 0: default:
				pdr_v1_X_Changes.addAllChanges(changeInfos);
				break;
		}
		...
		StyledButton btn1_1 = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "1.0"){
			@Override
		...
		StyledButton btn0_9 = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "SPD"){
			@Override
			protected void onClick() {
				super.onClick();
