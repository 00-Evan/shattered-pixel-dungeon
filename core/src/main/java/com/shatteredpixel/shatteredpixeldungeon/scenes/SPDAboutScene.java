...
public class SPDAboutScene extends PixelScene {
    ...
    public void create() {
        ...
        CreditsBlock wata = new CreditsBlock(true, Window.WATA_COLOR,
                "Pixel Dungeon",
                Icons.WATA.get(),
        ...
        CreditsBlock cube = new CreditsBlock(false, Window.WATA_COLOR,
                "Music:",
                Icons.CUBE_CODE.get(),
                "Cube Code",
                null,
        ...
        CreditsBlock arcnor = new CreditsBlock(false, Window.GDX_COLOR,
                "Pixel Dungeon GDX:",
                Icons.ARCNOR.get(),
                "Edu García",
                "twitter.com/arcnor",
        ...
        CreditsBlock purigro = new CreditsBlock(false, Window.GDX_COLOR,
                "Shattered GDX Help:",
                Icons.PURIGRO.get(),
                "Kevin MacMartin",
                "github.com/prurigro",
        ...
        transifex.setRect((Camera.main.width - colWidth)/2f, landscape() ? gdx.bottom() + 8 : arcnor.bottom() + 8, colWidth, 0);
