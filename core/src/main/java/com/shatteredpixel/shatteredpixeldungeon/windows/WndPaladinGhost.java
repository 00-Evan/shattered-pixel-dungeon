...
public class WndPaladinGhost extends Window {
	...
	public WndPaladinGhost(final PaladinGhost ghost, final int type ) {
		...
		switch (type){
			case 1:default:
				...
				titlebar.label( Messages.get(this, "vampire_title") );
	...
	private class RewardWindow extends WndInfoItem {
		...
		public RewardWindow( Item item ) {
			...
			RedButton btnConfirm = new RedButton(Messages.get(WndPaladinGhost.class, "confirm")){
				@Override
				protected void onClick() {
					WndPaladinGhost.RewardWindow.this.hide();

					WndPaladinGhost.this.selectReward( item );
				}
			};
			btnConfirm.setRect(0, height+2, width/2-1, 16);
			add(btnConfirm);

			RedButton btnCancel = new RedButton(Messages.get(WndPaladinGhost.class, "cancel")){
				@Override
				protected void onClick() {
					WndPaladinGhost.RewardWindow.this.hide();
				}
