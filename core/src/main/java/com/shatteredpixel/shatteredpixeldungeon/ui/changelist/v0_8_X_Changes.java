...
public class v0_8_X_Changes {
	...
	public static void add_v0_8_2_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton( ChangeIcons.V020_HORN, "Fifth Equipment Slot!",
		...
		changes.addButton(new ChangeButton( ChangeIcons.V082_NEWS, "Ingame News Feed",
		...
		changes.addButton(new ChangeButton( ChangeIcons.V081_DISPLAY_VERT, "Interface Improvements",
		...
		changes.addButton(new ChangeButton( ChangeIcons.V082_NETWORK, "Google Play Functionality",
		...
		changes.addButton(new ChangeButton( ChangeIcons.V075_BLASTWAVE, "Wand of Blast Wave",
		...
		changes.addButton(new ChangeButton( ChangeIcons.V082_FIREBLAST, "Wand of Fireblast",
		...
		changes.addButton(new ChangeButton( ChangeIcons.V074_WARDING, "Various Wand Buffs",
		...
		changes.addButton(new ChangeButton( ChangeIcons.V050_QUARTERSTAFF, "Quarterstaff",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V081_DISPLAY_VERT, "New Hero Select!",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V081_AUDIO, "Sound Effects",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V081_BUFF_MINDVIS, "Item and Buff Icons",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V063_MAGICMISSILE, "Wand of Magic Missile",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V081_POUCH, "Item Droprate and Inventory Managment",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V075_TENGU, "Boss Changes",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V081_DISPLAY_VERT, "Interface Adjustments",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V061_RING_AMETHYST, "Ring of Wealth and Lucky Enchant",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V062_ROGUE_HEROARM, "Assassin and Sniper",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V030_DISINTEGRATION, "Various Item Buffs",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V062_CORRUPTION, "Various Item Nerfs",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V060_GREATAXE, "Various Weapon Nerfs",
	...
	public static void add_v0_8_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( ChangeIcons.V080_DM100, "Misc Enemies",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V080_SHAMAN, "Caves",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V080_DM300, "DM300",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V080_FROST_ELEMENTAL, "Dwarven City",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V080_SPAWNER, "Demon Halls",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V080_YOG, "Yog-Dzewa",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V080_DISTORTION_TRAP, "Trap Adjustments",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V080_HEROARM_WARRIOR, "Weapon and Armor Changes",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V061_STATUE, "AI Tweaks",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V074_LIBGDX, "libGDX Desktop Functionality",
				"The desktop version of the game is now running through the same codebase as the Android version! Prior updates (back to v0.2.2) have been using a separate desktop-specific codebase.\n\n" +
		...
		changes.addButton( new ChangeButton( ChangeIcons.V080_SCROLL_TIWAZ, "Update Notification",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V080_SPIRIT_BOW, "Sniper Shot",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V080_BUFF_BLESS, "Bless changes",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V080_NECROMANCER, "Necromancers",
		...
		changes.addButton( new ChangeButton( ChangeIcons.V080_GUARD, "Enemy Nerfs",
