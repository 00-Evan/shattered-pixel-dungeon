...
public class v0_6_X_Changes {
	...
	public static void add_v0_6_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.WARRIOR_M, 0, 90, 12, 15), "Berserker",
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.MAGE_M, 0, 90, 12, 15), "Warlock",
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.HUNTRESS_F, 0, 15, 12, 15), "Huntress",
	...
	public static void add_v0_6_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.ROGUE_M, 0, 15, 12, 15), "Rogue Rework!",
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.ROGUE_M, 0, 90, 12, 15), "Rogue Subclasses Rework!",
