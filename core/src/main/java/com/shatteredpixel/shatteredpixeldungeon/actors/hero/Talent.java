...
public enum Talent {
	...
	//Rogue T2
	MYSTICAL_MEAL(68), INSCRIBED_STEALTH(69), ROGUES_EXPERTISE(70), SILENT_STEPS(71), SMART_ESCAPE(72),
	//Rogue T3
	...
	public static void initClassTalents( HeroClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents, LinkedHashMap<Talent, Talent> replacements ){
		...
		switch (cls){
			...
			case MAGE:
				...
				break;
			case ROGUE:
				Collections.addAll(tierTalents, MYSTICAL_MEAL, INSCRIBED_STEALTH, ROGUES_EXPERTISE, SILENT_STEPS, SMART_ESCAPE);
				break;
			case HUNTRESS:
