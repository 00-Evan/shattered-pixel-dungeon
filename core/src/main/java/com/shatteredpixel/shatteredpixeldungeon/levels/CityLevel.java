...
public class CityLevel extends RegularLevel {
	...
	public static class RedSmoke extends Emitter {
		...
		public static final Emitter.Factory factory = new Factory() {
			...
			@Override
			public void emit( Emitter emitter, int index, float x, float y ) {
				RedSmokeParticle p = (RedSmokeParticle)emitter.recycle( RedSmokeParticle.class );
				p.reset( x, y );
			}
		};

		public RedSmoke( int pos ) {
			super();
	...
	public static final class RedSmokeParticle extends PixelParticle {

		public RedSmokeParticle() {
			super();
