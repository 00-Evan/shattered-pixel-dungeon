...
import com.right.helveticpixeldungeon.actors.facilities.WorkTable;
...
public abstract class RegularLevel extends Level {
    ...
    protected void creatFacilities() {
        super.creatFacilities();
//        for (Room room : rooms) {
//            int pos = this.pointToCell(room.random());
//            room.
//            if (pos >= 0 && pos < this.length() && this.map[pos] == Terrain.HIGH_GRASS) {
