...
public class WaterDM300Sprite extends MobSprite {
	...
	public void link(Char ch) {
		...
		if (ch instanceof WaterDM300 && ((WaterDM300) ch).isSupercharged()){
