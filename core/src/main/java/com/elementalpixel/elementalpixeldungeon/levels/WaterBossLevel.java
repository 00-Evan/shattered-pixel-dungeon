...
public class WaterBossLevel extends Level {
	...
	public String tileDesc( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return super.tileDesc( tile ) + "\n\n" + Messages.get(WaterBossLevel.class, "water_desc");
	...
	public static class ArenaVisuals extends CustomTilemap {
		...
		public String name(int tileX, int tileY) {
			...
			if (Dungeon.level.map[i] == Terrain.INACTIVE_TRAP){
				return Messages.get(WaterBossLevel.class, "wires_name");
			} else if (gate.inside(Dungeon.level.cellToPoint(i))){
				return Messages.get(WaterBossLevel.class, "gate_name");
			}
		...
		public String desc(int tileX, int tileY) {
			int i = tileX + tileW*(tileY + this.tileY);
			if (Dungeon.level.map[i] == Terrain.INACTIVE_TRAP){
				return Messages.get(WaterBossLevel.class, "wires_desc");
			} else if (gate.inside(Dungeon.level.cellToPoint(i))){
				if (Dungeon.level.solid[i]){
					return Messages.get(WaterBossLevel.class, "gate_desc");
				} else {
					return Messages.get(WaterBossLevel.class, "gate_desc_broken");
				}
			}
	...
	public static class WaterPylonEnergy extends Blob {
		...
		public String tileDesc() {
			return Messages.get(WaterBossLevel.class, "energy_desc");
		}
