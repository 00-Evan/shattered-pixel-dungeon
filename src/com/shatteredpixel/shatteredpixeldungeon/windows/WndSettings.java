...
public class WndSettings extends Window {
	...
	public WndSettings(boolean inGame) {
		...
		if (!inGame) {
			...
			btnCounterLandscape.checked(ShatteredPixelDungeon.counterLandscape());
			btnCounterLandscape.enable(android.os.Build.VERSION.SDK_INT >= 9 && ShatteredPixelDungeon.landscape());
