...
public class AboutScene extends PixelScene {
	...
	public void create() {
		...
		final float colWidth = Camera.main.width / (ShatteredIceDungeon.landscape() ? 2 : 1);
		final float colTop = (Camera.main.height / 2) - (ShatteredIceDungeon.landscape() ? 30 : 90);
		final float wataOffset = ShatteredIceDungeon.landscape() ? colWidth : 0;
		...
		wata.y = align( ShatteredIceDungeon.landscape() ?
						colTop:
